...
class LoadOccupancy(object):
    ...
    def __call__(self, results):
        ...
        # visible_mask = torch.ones_like(visible_mask) # remove visible mask

        if self.ignore_nonvisible:
            occupancy[~visible_mask.to(torch.bool)] = 255
            # occupancy[~visible_mask.to(torch.bool) & (occupancy==17)] = 255 # add more voxels to train
        ...
        if results['rotate_bda'] != 0:
            ...
            visible_mask = visible_mask.permute(2, 0, 1)
            visible_mask = rotate(visible_mask, -results['rotate_bda'], fill=1).permute(1, 2, 0)
...
class PrepareImageInputs(object):
    ...
    def get_inputs(self, results, scale=None):
        ...
        for cam_name in cam_names:
            ...
            # img.save("test_img_{}.png".format(cam_name))
