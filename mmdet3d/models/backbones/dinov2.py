...
class DINOv2(nn.Module):
    ...
    def __init__(self, version='large', freeze=False, load_from=None):
        ...
        if version == 'large':
            ...
            self.dinov2 = torch.hub.load('torchhub/facebookresearch_dinov2_main', 'dinov2_vitb14', source='local', pretrained=False)
        elif version == 'small':
            self.dinov2 = torch.hub.load('torchhub/facebookresearch_dinov2_main', 'dinov2_vits14', source='local', pretrained=False)
        else:
        ...
        self.dinov2.mask_token.requires_grad=False
        self.freeze = freeze
